...
var b={yaxes:[{min:0,tickFormatter:function(a){return TP.utils.format("mi","mi",a)}},{min:0,tickFormatter:function(a){return TP.utils.format("min","s",a)}}]}
this.$(".plot").width("100%").height("300px").plot(a,b)}}})
TP.components.planpreview=function(a){var d=new b({id:$(a).data("plan-id")})
return new c({model:d,el:a})}}(),function(){function a(a,b,c){if(a="string"==typeof a?f[a]:a,b="string"==typeof b?f[b]:b||f[a.base],!a||!b||a.base!==b.base)throw Error("Invalid conversion")
...
return b(e,c)}function d(b,d,e,g){from_="string"==typeof b?f[b]:b,to_="string"==typeof d?f[d]:d||f[from_.base],e=a(from_,to_,e,g)
var h=to_.format?to_.format(e,g):c(3,e).toString(),i="label"in to_?to_.label:d
return i&&(h+=" "+i),h}function e(a,b){function c(a){var b=a.toString()
return b.length<2?"0"+b:b}var d=Math.floor(a/3600),e=Math.floor(a/60)%60,f=Math.floor(a)%60,g=d.toString()+":"+c(e)
return b&&b.seconds&&(g+=":"+c(f)),g}var f={m:{base:"m",factor:1},mi:{base:"m",factor:1609.34},km:{base:"m",factor:1e3},s:{base:"s",factor:1,format:e,label:""},min:{base:"s",factor:60},h:{base:"s",factor:3600}}
