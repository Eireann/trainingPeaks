define([],function()
{
  ...
  // transport
  if ( doDefine && typeof define === 'function' && define.amd ) {
    // AMD
    define( "classie", [], function(){return classie;} );
  } else {
    // browser global
  ...
  if (doDefine &&  typeof define === 'function' && define.amd ) {
    // AMD
    define( "get-style-property", [], function() {
  ...
  if (doDefine &&  typeof define === 'function' && define.amd ) {
    // AMD
    define( "get-size", [ 'get-style-property' ], defineGetSize );
  } else {
    // browser global
  ...
  if ( _.isFunction(docElem.addEventListener) ) {
    bind = function( obj, type, fn ) {
      if(_.isFunction(obj.addEventListener))
      {
  ...
  if (doDefine &&  typeof define === 'function' && define.amd ) {
    // AMD
    define( "eventie", [], function(){return eventie;} );
  } else {
    // browser global
  ...
  if (doDefine &&  typeof define === 'function' && define.amd ) {
    ...
    define( "doc-ready", [ 'eventie' ], defineDocReady );
  } else {
    // browser global
  ...
  if(typeof Element !== "undefined" && typeof Element.prototype !== "undefined")
  {
    ( function( global, ElemProto ) {
      ...
      if (doDefine &&  typeof define === 'function' && define.amd ) {
        // AMD
        define( "matches-selector", [], function() {
          return matchesSelector;
        });
      } else {
        // browser global
  ...
  **/
  ...
  Item.prototype._transition = function( args ) {
    ...
    if(_.isFunction(this.element.addEventListener))
    {
  ...
  **/
  ...
  if (doDefine &&  typeof define === 'function' && define.amd ) {
    // AMD
    define( "packer", [ 'rect' ], packerDefinition );
  } else {
    // browser global
