...
require(
{
    ...
    paths:
    {
        ...
        "backbone": "base/vendor/js/libs/backbone.amd",
        "backbone.eventbinder": "base/vendor/js/libs/backbone.eventbinder.amd",
        "backbone.babysitter": "base/vendor/js/libs/backbone.babysitter.amd",
        "backbone.wreqr": "base/vendor/js/libs/backbone.wreqr.amd",
        "backbone.marionette": "base/vendor/js/libs/backbone.marionette.amd",
        "Backbone.Marionette.Handlebars": "base/vendor/jam/Backbone.Marionette.Handlebars/backbone.marionette.handlebars",
        "handlebars": "base/vendor/jam/Backbone.Marionette.Handlebars/backbone.marionette.handlebars",       
