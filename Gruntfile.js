    ...
    grunt.initConfig(
    {
        ...
        copy:
        {
            ...
            "uat":
            {
                files:
                {
                    "build/uat": ["assets/fonts/**", "assets/images/**", "app/scripts/affiliates/**", "!app/scripts/affiliates/**/*.js"]
                }
            },
            ...
            dev:
            {
                files:
                {
                    "build/dev": ["assets/fonts/**", "assets/images/**", "app/scripts/affiliates/**", "!app/scripts/affiliates/**/*.js"]
                }
            },
