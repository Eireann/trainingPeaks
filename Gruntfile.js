    ...
    grunt.initConfig(
    {
        ...
        copy:
        {
            debug:
            {
                files:
                {
                    "build/debug": ["web.config", "assets/images/**", "app/scripts/affiliates/**", "!app/scripts/affiliates/**/*.js"]
                }
            },
            ...
            release:
            {
                files:
                {
                    "build/release": ["web.config", "assets/images/**", "app/scripts/affiliates/**", "!app/scripts/affiliates/**/*.js"]
                }
            },
            ...
            uat:
            {
                files:
                {
                    "build/uat": ["web.config", "assets/images/**", "app/scripts/affiliates/**", "!app/scripts/affiliates/**/*.js"]
                }
            },
            ...
            dev:
            {
                files:
                {
                    "build/dev": ["web.config", "assets/images/**", "app/scripts/affiliates/**", "!app/scripts/affiliates/**/*.js"]
                }
            },
